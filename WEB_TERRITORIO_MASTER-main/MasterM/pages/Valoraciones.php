...
<head>
    ...
    <title>Valoraciones | MasterM</title>
...
<body>
    ...
    <main class="container py-5">
            ...
            <div class="col-lg-10">
                <div class="card border-0 shadow-sm p-5 text-center">
                    ...
                    <h1 class="display-5 fw-bold mb-3">
                        Más de <span style="color:#00adb5;">1500 alumnos</span> ya confían en nosotros
                    </h1>
                    ...
                    <p class="fw-bold mb-2">Valoración media: 4.9 / 5</p>

                    <p class="text-muted mx-auto" style="max-width:700px;">
                        La experiencia de nuestros alumnos es el reflejo de nuestra metodología: práctica real,
                        profesores en activo y enfoque directo al empleo.
                    </p>
        ...
        <!-- TESTIMONIOS PRINCIPALES (CON AVATAR) -->
        <div class="row g-4 mb-4">
            ...
            <section class="col-md-6">
                <div class="card review-card p-4 h-100 shadow-sm">
                    ...
                    <p class="text-start">
                        “Gracias a MasterMedic conseguí trabajo en una clínica estética en menos de 3 meses.
                        La formación es práctica desde el primer día.”
                    </p>
            ...
            <section class="col-md-6">
                <div class="card review-card p-4 h-100 shadow-sm">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div>
                            <strong>Carlos Martín</strong><br>
                            <small class="text-muted">Médico</small>
                        </div>
                    </div>

                    <p class="text-start">
                        “Nada que ver con otros cursos. Aquí trabajas con pacientes reales y sales preparado.”
                    </p>
        ...
        <div class="row g-4">
            ...
            <section class="col-md-4">
                <div class="card review-card p-4 text-center shadow-sm">

                    <p class="text-start">“Muy recomendable, formación directa y clara.”</p>
                    <strong>Ana</strong>
                </div>
            </section>
            ...
            <section class="col-md-4">
                <div class="card review-card p-4 text-center shadow-sm">
                    <p class="text-start">“Profesores top y muy cercanos.”</p>
            ...
            <section class="col-md-4">
                <div class="card review-card p-4 text-center shadow-sm">
                    ...
                    <p class="text-start">“Me ayudó a cambiar mi carrera.”</p>
                    <strong>Lucía</strong>
                </div>
            </section>
        ...
        <section class="text-center mt-5">
            <h3 class="fw-bold mb-3">Tú puedes ser el siguiente</h3>
            <p class="text-center mb-4">Plazas limitadas · Próxima convocatoria abierta</p>
            <a href="contacto.php" class="btn btn-primary px-4">Solicitar información</a>
        </section>
