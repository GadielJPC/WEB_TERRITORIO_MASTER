...
<body>
    ...
    <main class="container my-5">
        ...
        <section class="text-center mb-4">
            ...
            <p class="text-muted">Accede a tus contenidos y formación online</p>
        </section>
        ...
        <section class="row g-4 mb-4">
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">
                            Continúa tu formación accediendo a tus cursos activos.
                        </p>
                        <a href="cursos.php" class="med-btn med-btn-outline btn-sm">Entrar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">Acceso al aula</h5>
                        <p class="card-text text-muted">
                            Entra en la plataforma para seguir tu formación.
                        </p>
                        <a href="#" class="med-btn med-btn-outline btn-sm">Acceder</a>
                    </div>
                </div>
            </div>
        </section>
