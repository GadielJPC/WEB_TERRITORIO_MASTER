...
$resultado = mysqli_query($conexion, "SELECT * FROM cursos WHERE id = 1");
            ...
            <div class="text-center">
                <div class="asig-price-box">
                    <div class="text-start text-center-mobile">
                        <span class="text-muted text-uppercase fw-bold" style="letter-spacing: 1px;">
                            Inversión desde
                        </span>
                        <!-- Sustituimos el monto fijo por el dato de la BD -->
                        <div class="asig-price-amount">
