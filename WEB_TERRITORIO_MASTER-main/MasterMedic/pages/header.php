...
<header class="header">
    <div class="header-container position-relative">
        <div class="logo-area pt-4">
            <a href="index.php">
                <img src="../assets/images/Logoemp.png" alt="MasterMedic" class="logo-img site-logo-img">
            </a>
        </div>
                            ...
                            if ($conexion) {
                                ...
                                if (mysqli_num_rows($query_menu) > 0) {
                                    while ($item = mysqli_fetch_assoc($query_menu)) {
                                        echo '<li><a href="master.php?tipo=' . $item['url_enlace'] . '">' . $item['titulo'] . '</a></li>';
                                    }
                                } else {
